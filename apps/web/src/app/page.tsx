      ...
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
        ...
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          ...
          <p className="max-w-md text-lg leading-8 text-zinc-600 dark:text-zinc-400">
            Next.js frontend connected to NestJS API
          </p>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                {isLoading
                  ...
                  : "Not connected to NestJS API"}
              </span>
            </div>
          </div>

          {apiStatus && isConnected && (
            <div className="mt-2 rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-3 dark:border-zinc-800 dark:bg-zinc-900">
              <div className="text-sm text-zinc-600 dark:text-zinc-400">
                <div className="font-medium text-zinc-800 dark:text-zinc-200">
                  {apiStatus.service}
                </div>
                <div className="mt-1 text-xs">
                  Version: {apiStatus.version} | Last check:{" "}
